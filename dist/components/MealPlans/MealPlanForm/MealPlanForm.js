...
export default function MealPlanForm(_a) {
    ...
    return (_jsxs("div", __assign({ className: "bg-yellowgreen m-1 w-5/6 rounded-lg shadow-sm" }, { children: [_jsxs("div", __assign({ className: "grid grid-cols-5 font-semibold text-md" }, { children: [_jsx("div", { children: name }), _jsxs("div", { children: [totalCalories, "kcal"] }), _jsxs("div", { children: [totalProtein, "g"] }), _jsxs("div", { children: [totalCarbohydrates, "g"] }), _jsxs("div", { children: [totalFat, "g"] })] })), _jsxs("div", __assign({ className: "rounded-b-lg grid grid-cols-3 bg-eggplant" }, { children: [_jsx(Link, __assign({ className: "m-1 px-1 border-2 border-black bg-celestialblue text-white rounded-md hover:bg-frenchblue font-semibold", to: { pathname: "/mealplans/".concat(id) } }, { children: "Details" })), !isMealPlanPage ? (_jsx("button", __assign({ className: "m-1 px-1 border-2 border-black bg-celestialblue text-white rounded-md hover:bg-frenchblue font-semibold", onClick: function () { return addFoodToMealPlan(id, foodId); } }, { children: "Add" }))) : (_jsx(_Fragment, {})), isMealPlanPage ? (_jsxs(_Fragment, { children: [_jsx(Link, __assign({ to: {
