...
export default function WorkoutDetailsPage(_a) {
    ...
    return (_jsxs("div", __assign({ className: "flex flex-col justify-center items-center" }, { children: [_jsxs("h1", __assign({ className: "font-semibold text-4xl mt-7 mb-5 " }, { children: [thisWorkout.name, " Workout Details"] })), _jsx("div", __assign({ className: "w-9/12 flex justify-center" }, { children: exercisesItems }))] })));
}
