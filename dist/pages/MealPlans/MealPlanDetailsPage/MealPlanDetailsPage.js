...
export default function MealPlanDetailsPage(_a) {
    ...
    return (_jsxs("div", __assign({ className: "flex flex-col justify-center items-center" }, { children: [_jsxs("h1", __assign({ className: "font-semibold text-4xl mt-7 mb-5 " }, { children: [thisMealPlan.name, " Meal Plan Details"] })), _jsxs("div", __assign({ className: "flex justify-center items-center flex-col w-1/5 min-h-3/4 h-full bg-yellowgreen shadow-lg rounded-lg border-2 border-black mb-6" }, { children: [_jsxs("div", { children: [_jsx("span", __assign({ className: "font-semibold" }, { children: "Total Calories:" })), " ", thisMealPlan.totalCalories] }), _jsxs("div", { children: [_jsx("span", __assign({ className: "font-semibold" }, { children: "Total Protein:" })), " ", thisMealPlan.totalProtein] }), _jsxs("div", { children: [_jsx("span", __assign({ className: "font-semibold" }, { children: "Total Carbohydrates:" })), " ", thisMealPlan.totalCarbohydrates] }), _jsxs("div", { children: [_jsx("span", __assign({ className: "font-semibold" }, { children: "Total Fat:" })), " ", thisMealPlan.totalFat] })] })), foodItems] })));
}
