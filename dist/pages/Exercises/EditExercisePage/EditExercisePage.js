...
export default function EditExercisePage(_a) {
    ...
    return (_jsxs("div", __assign({ className: "flex flex-col justify-center items-center" }, { children: [_jsx("h1", __assign({ className: "font-semibold text-4xl mt-7 mb-5 " }, { children: "Edit the Exercise" })), _jsx("div", __assign({ className: "flex justify-center items-center w-1/2 mb-5" }, { children: _jsx("div", __assign({ className: "flex justify-center items-center flex-col min-w-1/2 w-1/2 min-h-3/4 h-full bg-caramel shadow-lg rounded-lg border-2 border-black" }, { children: _jsxs("form", __assign({ onSubmit: handleEditExercise }, { children: [_jsxs("label", __assign({ className: "text-left block text-base mt-2 text-black font-semibold" }, { children: ["Name", _jsx("input", { className: "border w-full text-base px-2 py-1 focus:outline-none focus:ring-0 focus:border-gray-600", name: "name", type: "text", onChange: handleOnChange, value: newExercise.name, placeholder: name, required: true, autoComplete: "off" })] })), _jsxs("label", __assign({ className: "text-left block text-base mt-2 text-black font-semibold" }, { children: ["Type", _jsx("input", { className: "border w-full text-base px-2 py-1 focus:outline-none focus:ring-0 focus:border-gray-600", name: "type", type: "text", onChange: handleOnChange, value: newExercise.type, placeholder: type, required: true, autoComplete: "off" })] })), _jsxs("label", __assign({ className: "text-left block text-base mt-2 text-black font-semibold" }, { children: ["Muscle", _jsx("input", { className: "border w-full text-base px-2 py-1 focus:outline-none focus:ring-0 focus:border-gray-600", name: "muscle", type: "text", onChange: handleOnChange, value: newExercise.muscle, placeholder: muscle, required: true, autoComplete: "off" })] })), _jsxs("label", __assign({ className: "text-left block text-base mt-2 text-black font-semibold" }, { children: ["Grip", _jsx("input", { className: "border w-full text-base px-2 py-1 focus:outline-none focus:ring-0 focus:border-gray-600", name: "grip", type: "text", onChange: handleOnChange, value: newExercise.grip, placeholder: grip, required: true, autoComplete: "off" })] })), _jsxs("label", __assign({ className: "text-left block text-base mt-2 text-black font-semibold" }, { children: ["Width", _jsx("input", { className: "border w-full text-base px-2 py-1 focus:outline-none focus:ring-0 focus:border-gray-600", name: "width", type: "text", onChange: handleOnChange, value: newExercise.width, placeholder: width, required: true, autoComplete: "off" })] })), _jsx("div", __assign({ className: "mt-5" }, { children: _jsxs("button", __assign({ className: "mb-2 border-2 border-black bg-celestialblue text-white w-3/4 rounded-md hover:bg-orange-400 font-semibold" }, { children: [_jsx("i", { className: "fa-solid fa-right-to-bracket" }), "Confirm Edit"] })) }))] })) })) }))] })));
}
