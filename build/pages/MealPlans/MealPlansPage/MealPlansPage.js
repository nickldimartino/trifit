...
export default function MealPlanPage(_a) {
    ...
    return (_jsxs("div", { className: "flex justify-around mt-10", children: [_jsx("div", { className: "w-3/4", children: _jsx(MealPlanList, { mealPlans: mealPlans, deleteMealPlan: deleteMealPlan, addFoodToMealPlan: addFoodToMealPlan }) }), _jsx("div", { className: "flex justify-center mb-5 w-3/4", children: _jsx(NewMealPlanForm, { addNewMealPlan: addNewMealPlan }) })] }));
}
