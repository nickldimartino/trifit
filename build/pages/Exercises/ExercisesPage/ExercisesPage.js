...
export default function ExercisesPage(_a) {
    ...
    return (_jsx(_Fragment, { children: _jsxs("div", { className: "flex justify-around mt-10", children: [_jsx("div", { className: "w-3/4", children: _jsx(ExercisesList, { exercises: exercises, addExerciseToWorkout: addExerciseToWorkout, deleteExercise: deleteExercise, user: user }) }), user.isAdmin === "true" ? (_jsx("div", { className: "flex justify-center mb-5 w-3/4", children: _jsx(NewExerciseForm, { addNewExercise: addNewExercise }) })) : (_jsx(_Fragment, {}))] }) }));
}
