...
export default function BodyStatsPage() {
    ...
    return (_jsxs(_Fragment, { children: [_jsxs("div", { className: "grid grid-cols-2 mt-10", children: [_jsx(NewBodyStatForm, { addBodyStat: addBodyStat }), _jsx("div", { style: { width: "600px", height: "300px", backgroundColor: "white" }, className: "mr-10", children: _jsx(Scatter, { data: data, options: options, className: " border-2 border-black rounded-sm shadow-lg" }) })] }), _jsx(PersonalTrainer, {})] }));
}
