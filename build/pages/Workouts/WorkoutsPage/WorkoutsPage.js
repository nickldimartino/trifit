...
export default function WorkoutsPage(_a) {
    ...
    return (_jsxs("div", { className: "flex justify-around mt-10", children: [_jsx("div", { className: "w-3/4", children: _jsx(WorkoutsList, { workouts: workouts, deleteWorkout: deleteWorkout, addExerciseToWorkout: addExerciseToWorkout }) }), _jsx("div", { className: "flex justify-center mb-5 w-3/4", children: _jsx(NewWorkoutForm, { addNewWorkout: addNewWorkout }) })] }));
}
