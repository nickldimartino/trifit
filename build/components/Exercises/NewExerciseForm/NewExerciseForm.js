...
export default function NewExerciseForm(_a) {
    ...
    return (_jsx("div", { className: "flex justify-center items-center", children: _jsxs("div", { className: "flex justify-center items-center flex-col p-2 bg-caramel shadow-lg rounded-lg border-2 border-black", children: [_jsxs("h1", { "data-testid": "new-exercise-header", className: "text-2xl block text-center text-black font-semibold", children: [_jsx("i", { className: "fa-solid fa-user" }), " Add an Exercise"] }), _jsx("hr", { className: "mt-1" }), _jsxs("form", { onSubmit: handleAddExercise, children: [_jsxs("label", { className: "text-left block text-base mt-2 text-black font-semibold", children: ["Name", _jsx("input", { className: "border w-full text-base px-2 py-1 focus:outline-none focus:ring-0 focus:border-gray-600", name: "name", type: "text", onChange: handleOnChange, value: newExercise.name, placeholder: "Enter a name...", required: true, autoComplete: "off" })] }), _jsxs("label", { className: "text-left block text-base mt-2 text-black font-semibold", children: ["Type", _jsx("input", { className: "border w-full text-base px-2 py-1 focus:outline-none focus:ring-0 focus:border-gray-600", name: "type", type: "text", onChange: handleOnChange, value: newExercise.type, placeholder: "Enter an exercise type...", required: true, autoComplete: "off" })] }), _jsxs("label", { className: "text-left block text-base mt-2 text-black font-semibold", children: ["Main Muscle Groups Worked", _jsx("input", { className: "border w-full text-base px-2 py-1 focus:outline-none focus:ring-0 focus:border-gray-600", name: "muscle", type: "text", onChange: handleOnChange, value: newExercise.muscle, placeholder: "Enter the main muscle groups...", required: true, autoComplete: "off" })] }), _jsxs("label", { className: "text-left block text-base mt-2 text-black font-semibold", children: ["Hand/Foot Placement", _jsx("input", { className: "border w-full text-base px-2 py-1 focus:outline-none focus:ring-0 focus:border-gray-600", name: "grip", type: "text", onChange: handleOnChange, value: newExercise.grip, placeholder: "Enter the hand/foot placement...", required: true, autoComplete: "off" })] }), _jsxs("label", { className: "text-left block text-base mt-2 text-black font-semibold", children: ["Hand/Foot Width", _jsx("input", { className: "border w-full text-base px-2 py-1 focus:outline-none focus:ring-0 focus:border-gray-600", name: "width", type: "text", onChange: handleOnChange, value: newExercise.width, placeholder: "Enter the hand/foot width...", required: true, autoComplete: "off" })] }), _jsx("div", { className: "mt-5", children: _jsxs("button", { className: "mb-2 border-2 border-black bg-celestialblue text-white w-3/4 rounded-md hover:bg-frenchblue font-semibold", children: [_jsx("i", { className: "fa-solid fa-right-to-bracket" }), "Add"] }) })] })] }) }));
}
